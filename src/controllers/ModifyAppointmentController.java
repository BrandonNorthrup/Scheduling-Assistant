...
public class ModifyAppointmentController implements Initializable {
    ...
    public boolean handleModifyAppointment(int id) {
        ...
        if(DatabaseAppointment.overlappingAppointment(id, location.getText(), ld.toString(), times.get(aptTime))) {
            errors.add("Overlapping Appointments");
            return false;
        }
        if(DatabaseAppointment.updateAppointment(id, types.get(aptType), contacts.get(aptContact), location.getText(), ld.toString(), times.get(aptTime))) {
            return true;
        } else {
